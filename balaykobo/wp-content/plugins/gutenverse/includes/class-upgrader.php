		...
		if ( $this->check_old_theme( $theme ) && $flag ) {
			...
			<div class="notice gutenverse-upgrade-notice page-content-upgrade">
				...
				<div class="notice-content">
					...
					<p><?php echo sprintf( esc_html__( 'We detect you are using %s theme. There are some new exciting updates we want to announce. This update will required the latest version of %s theme to work smoothly, so we recommend to update your %s theme.', 'gutenverse' ), $theme->name, $theme->name, $theme->name ); ?>
