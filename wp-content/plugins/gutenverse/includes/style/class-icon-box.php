...
class Icon_Box extends Style_Abstract {
	...
	public function icon_box_style() {
		...
		if ( isset( $this->attrs['iconBackground'] ) ) {
			$this->handle_background( ".{$this->element_id} .icon-box.icon-box-header .icon.style-gradient", $this->attrs['iconBackground'] );
		}

		if ( isset( $this->attrs['iconBackgroundHover'] ) ) {
			$this->handle_background( ".{$this->element_id}:hover .icon-box.icon-box-header .icon.style-gradient", $this->attrs['iconBackgroundHover'] );
		}
